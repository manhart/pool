...
* variable.
*/
	$mail_1->setReturnPath('manhart@wochenblatt.de');
	$mail_1->setFrom('John Doe <manhart@wochenblatt.de>');
	$mail_1->setSubject('Test attached email');
	$mail = $mail_1->getRFC822(array('Nobody <manhart@wochenblatt.de>'));
...
*/
	...
	$mail_2->setFrom('Foo <manhart@wochenblatt.de>');
	$mail_2->setSubject('Test with attached email');
	$result = $mail_2->send(array('manhart@wochenblatt.de'));
